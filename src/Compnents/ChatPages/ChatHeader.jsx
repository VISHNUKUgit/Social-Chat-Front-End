...
const ChatHeader = () => {
  ...
  return (
    <div className='w-100 bg-dark d-flex align-items-center' style={{ height: '10%' }}>
      ...
      >
        {userData.picture !=='default_profile_picture.jpg' ? (
          <img src={userData.picture} alt={userData.username} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        ) : (
          userData.username && <span>{userData.username[0].toUpperCase()}</span>
        )}
      </div>
